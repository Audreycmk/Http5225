<?php
  ...
  if(isset($_POST['updateSchool'])){ 
    ...
    if($school){
      ...
      echo 'Unable to update the school, Error code:' . mysqli_error();
    }
  }
?>
        ...
        <div class="col-md-6">
          <form action="updateschool.php" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="boardname" id="boardname" aria-describedby="boardname" value="<?php echo $result ['Board'] ?>">
            </div>

            <div class="mb-3">
              <label for="language" class="form-label">Language</label>
              <input type="text" class="form-control" name="language" id="language" aria-describedby="language" value="<?php echo $result ['Language']?>">
            </div>

            <div class="mb-3">
              <label for="schooltype" class="form-label">School Type</label>
              <input type="text" class="form-control" name="schooltype" id="schooltype" aria-describedby="schooltype" value="<?php echo $result ['School Type']?>">
            </div>
